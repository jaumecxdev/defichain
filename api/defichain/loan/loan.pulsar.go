...
func init() {
	...
	md_Loan = File_defichain_loan_loan_proto.Messages().ByName("Loan")
...
func (x *Loan) slowProtoReflect() protoreflect.Message {
	mi := &file_defichain_loan_loan_proto_msgTypes[0]
...
func (x *fastReflection_Loan) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "defichain.loan.Loan.id":
		return x.Id != uint64(0)
	case "defichain.loan.Loan.amount":
		return x.Amount != ""
	case "defichain.loan.Loan.fee":
		return x.Fee != ""
	case "defichain.loan.Loan.collateral":
		return x.Collateral != ""
	case "defichain.loan.Loan.deadline":
		return x.Deadline != ""
	case "defichain.loan.Loan.state":
		return x.State != ""
	case "defichain.loan.Loan.borrower":
		return x.Borrower != ""
	case "defichain.loan.Loan.lender":
		return x.Lender != ""
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: defichain.loan.Loan"))
		}
		panic(fmt.Errorf("message defichain.loan.Loan does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_Loan) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message defichain.loan.Loan does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_Loan) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "defichain.loan.Loan.id":
		panic(fmt.Errorf("field id of message defichain.loan.Loan is not mutable"))
	case "defichain.loan.Loan.amount":
		panic(fmt.Errorf("field amount of message defichain.loan.Loan is not mutable"))
	case "defichain.loan.Loan.fee":
		panic(fmt.Errorf("field fee of message defichain.loan.Loan is not mutable"))
	case "defichain.loan.Loan.collateral":
		panic(fmt.Errorf("field collateral of message defichain.loan.Loan is not mutable"))
	case "defichain.loan.Loan.deadline":
		panic(fmt.Errorf("field deadline of message defichain.loan.Loan is not mutable"))
	case "defichain.loan.Loan.state":
		panic(fmt.Errorf("field state of message defichain.loan.Loan is not mutable"))
	case "defichain.loan.Loan.borrower":
		panic(fmt.Errorf("field borrower of message defichain.loan.Loan is not mutable"))
	case "defichain.loan.Loan.lender":
		panic(fmt.Errorf("field lender of message defichain.loan.Loan is not mutable"))
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: defichain.loan.Loan"))
		}
...
func (x *fastReflection_Loan) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in defichain.loan.Loan", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: defichain/loan/loan.proto
...
func (*Loan) Descriptor() ([]byte, []int) {
	return file_defichain_loan_loan_proto_rawDescGZIP(), []int{0}
}
...
var File_defichain_loan_loan_proto protoreflect.FileDescriptor

var file_defichain_loan_loan_proto_rawDesc = []byte{
	0x0a, 0x19, 0x64, 0x65, 0x66, 0x69, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2f, 0x6c, 0x6f, 0x61, 0x6e,
	0x2f, 0x6c, 0x6f, 0x61, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0e, 0x64, 0x65, 0x66,
	0x69, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x2e, 0x6c, 0x6f, 0x61, 0x6e, 0x22, 0xc6, 0x01, 0x0a, 0x04,
	0x4c, 0x6f, 0x61, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04,
	...
	0x66, 0x65, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x66, 0x65, 0x65, 0x12, 0x1e,
	...
	,
...
var (
	file_defichain_loan_loan_proto_rawDescOnce sync.Once
	file_defichain_loan_loan_proto_rawDescData = file_defichain_loan_loan_proto_rawDesc
)

func file_defichain_loan_loan_proto_rawDescGZIP() []byte {
	file_defichain_loan_loan_proto_rawDescOnce.Do(func() {
		file_defichain_loan_loan_proto_rawDescData = protoimpl.X.CompressGZIP(file_defichain_loan_loan_proto_rawDescData)
	})
	return file_defichain_loan_loan_proto_rawDescData
}

var file_defichain_loan_loan_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_defichain_loan_loan_proto_goTypes = []interface{}{
	(*Loan)(nil), // 0: defichain.loan.Loan
}
var file_defichain_loan_loan_proto_depIdxs = []int32{
...
func init() { file_defichain_loan_loan_proto_init() }
func file_defichain_loan_loan_proto_init() {
	if File_defichain_loan_loan_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_defichain_loan_loan_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Loan); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_defichain_loan_loan_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_defichain_loan_loan_proto_goTypes,
		DependencyIndexes: file_defichain_loan_loan_proto_depIdxs,
		MessageInfos:      file_defichain_loan_loan_proto_msgTypes,
	}.Build()
	File_defichain_loan_loan_proto = out.File
	file_defichain_loan_loan_proto_rawDesc = nil
	file_defichain_loan_loan_proto_goTypes = nil
	file_defichain_loan_loan_proto_depIdxs = nil
}
