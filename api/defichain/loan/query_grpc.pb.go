...
const (
	Query_Params_FullMethodName  = "/defichain.loan.Query/Params"
	Query_Loan_FullMethodName    = "/defichain.loan.Query/Loan"
	Query_LoanAll_FullMethodName = "/defichain.loan.Query/LoanAll"
)
